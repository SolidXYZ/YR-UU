...
function fetchWithTimeout(resource, options = {}) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const response = await fetch(resource, { ...options, signal: controller.signal, method: 'GET', referrerPolicy: 'unsafe-url', origin: 'https://solidxyz.github.io/YR-UU/', headers: {
