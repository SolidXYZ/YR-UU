...
function fetchWithTimeout(resource, options = {}) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const response = await fetch(resource, { ...options, signal: controller.signal, referrerPolicy: 'unsafe-url', origin: 'https://solidxyz.github.io/YR-UU/', headers: {
                'Access-Control-Allow-Origin': '*',
                'origin': 'https://solidxyz.github.io/YR-UU/',
            }});
            clearTimeout(id);
            resolve(response);
        } catch (error) {
