...
function getAutocompleteURL(str, types = 'all', lat = 0, lon = 0, strictbounds = false) {
    return getGeocodeURL(`https://cors-anywhere.herokuapp.com/` + `place/autocomplete/json?input=${str}&types=${types}&location=${lat.toString()}%2C${lon.toString()}&strictbounds=${strictbounds.toString()}`);
}
